...
void TestVersionInfo::testConstructor()
{
    // Default constructor
    {
        VersionInfo version;
        ...
        QCOMPARE(version.minor(), 2);
        QCOMPARE(version.patch(), 3);
        QCOMPARE(version.dev(), QString("dev"));
    }
    ...
    // Constructor
    {
        ...
        version = VersionInfo(4, 5, 6, "dev");

        QCOMPARE(version.major(), 4);
        QCOMPARE(version.minor(), 5);
        QCOMPARE(version.patch(), 6);
        QCOMPARE(version.dev(), QString("dev"));
    }
}
...
void TestVersionInfo::testIsValid_data()
{
    ...
    // Invalid versions
    QTest::addRow("%d", i++) << VersionInfo() << false;
...
void TestVersionInfo::testIsRangeValid_data()
{
    ...
    QTest::addRow("%d", i++) << VersionInfo() << VersionInfo() << false;
}
...
void TestVersionInfo::testIsVersionInRange_data()
{
    ...
    QTest::addRow("%d", i++) << VersionInfo(1, 9, 6, "a") << VersionInfo(1, 9, 6) << VersionInfo(1, 9, 6, "b") << true;
    ...
    QTest::addRow("%d", i++) << VersionInfo(1, 9, 6)  << VersionInfo(1, 9, 6, "b") << VersionInfo(1, 9, 6, "c") << false;
